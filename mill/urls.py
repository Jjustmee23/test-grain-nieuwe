...
urlpatterns = [
    ...
    path('device-suspicious-activity/<str:device_id>/', power_management_views.device_suspicious_activity, name='device_suspicious_activity'),
    path('device-detailed-analysis/<str:device_id>/', power_management_views.device_detailed_power_analysis, name='device_detailed_power_analysis'),
                path('export-device-power-analysis/<str:device_id>/', power_management_views.export_device_power_analysis, name='export_device_power_analysis'),
            path('export-incident-counter-changes/<str:device_id>/', power_management_views.export_incident_counter_changes, name='export_incident_counter_changes'),
            path('export-power-outages/<str:device_id>/', power_management_views.export_power_outages, name='export_power_outages'),
            path('device-power-history/<str:device_id>/', power_management_views.device_power_history, name='device_power_history'),
    path('all-devices-without-power/', power_management_views.all_devices_without_power, name='all_devices_without_power'),
