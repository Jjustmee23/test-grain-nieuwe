...
exports.UC300CellularDecoder = void 0;
class UC300CellularDecoder {
    /**
     ...
     */
    static decodeCellularPayload(deviceId, payload) {
        try {
     ...
     */
    static convertToVoltage(rawValue) {
     ...
     */
    static validateCellularPayload(payload) {
        const errors = [];
        if (!payload.deviceId) {
...
exports.UC300CellularDecoder = UC300CellularDecoder;
//# sourceMappingURL=uc300-cellular-decoder.js.map