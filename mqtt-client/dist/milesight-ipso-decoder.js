...
exports.MilesightIPSODecoder = void 0;
class MilesightIPSODecoder {
    /**
     ...
     */
    static decodeIPSO(deviceId, payload, fPort = 85) {
        try {
     ...
     */
    static decodeChannel(channel, dataType, data) {
        try {
            switch (channel) {
        ...
        catch (error) { // Explicitly type error as 'any' or 'Error'
     ...
     */
    static decodeFFChannel(dataType, data) {
        switch (dataType) {
     ...
     */
    static decodeDigitalInput(channel, dataType, data) {
     ...
     */
    static decodeDigitalOutput(channel, dataType, data) {
     ...
     */
    static decodePT100(channel, dataType, data) {
     ...
     */
    static decodeAnalogInput(channel, dataType, data) {
     ...
     */
    static decodeModbusData(dataType, data) {
        return {
            type: 'modbus-data',
            dataType,
     ...
     */
    static storeChannelData(decoded, channel, channelData) {
...
exports.MilesightIPSODecoder = MilesightIPSODecoder;
//# sourceMappingURL=milesight-ipso-decoder.js.map