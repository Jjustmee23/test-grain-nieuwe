...
class MilsightDecoder {
    ...
    static decodeHexPayload(hexPayload) {
        try {
            ...
            const counter1 = buffer.readUInt32LE(offset);
            offset += 4;
            const counter2 = buffer.readUInt32LE(offset);
            offset += 4;
            const counter3 = buffer.readUInt32LE(offset);
            offset += 4;
            const counter4 = buffer.readUInt32LE(offset);
            offset += 4;
            ...
            const ain1Value = this.convertAnalogValue(buffer.readUInt32LE(offset));
            offset += 4;
            const ain2Value = this.convertAnalogValue(buffer.readUInt32LE(offset));
            offset += 4;
            const ain3Value = this.convertAnalogValue(buffer.readUInt32LE(offset));
            offset += 4;
            const ain4Value = this.convertAnalogValue(buffer.readUInt32LE(offset));
            offset += 4;
            const ain5Value = this.convertAnalogValue(buffer.readUInt32LE(offset));
            offset += 4;
            const ain6Value = this.convertAnalogValue(buffer.readUInt32LE(offset));
            offset += 4;
            const ain7Value = this.convertAnalogValue(buffer.readUInt32LE(offset));
            offset += 4;
            const ain8Value = this.convertAnalogValue(buffer.readUInt32LE(offset));
            offset += 4;
     ...
     */
    static convertAnalogValue(rawValue) {
     ...
     */
    static parseDigitalStates(binaryString) {
...
exports.MilsightDecoder = MilsightDecoder;
//# sourceMappingURL=milsight-decoder.js.map